  ...
  new google.translate.TranslateElement({
    ...
    layout: google.translate.TranslateElement.InlineLayout.HORIZONTAL
			...
			<div class="d-flex justify-content-between align-items-center">
				...
				<div  class="px-1 pt-2 bg-success number text-center lead">
	...
	<div class="s-1 pt-5 pb-5">
		<div class="pt-5"></div>
		<div class="pt-5"></div>
		<div class="pt-5"></div>
		<h3 class="display-3 text-light pt-5 mx-5 px-5" style="font-weight:700">Services</h3>
		<p class="lead mx-5 px-5" style="font-size: 1.4em;"><span style="font-weight:700;color: #fff;">Accueil /</span> <span style="color:#e35e4c;font-weight: 700;">Service</span></p>
	</div>


	<div class="s-2 container pt-5 pb-5">
		<div class="d-flex justify-content-around align-items-center py-5">
			<div>
					<img class="img-fluid" src="../images/piggrow.png">
					<h6 class="lead mt-4 text-light" style="font-weight:700;">Élevage du porc </h6>
			</div>

			<div>
					<img class="img-fluid" src="../images/pet-food.png">
					<h6 class="lead mt-4 text-light" style="font-weight:700;">Transformation des produits porcins  </h6>

			</div>


			<div>
					<img class="img-fluid" src="../images/cross-selling.png">
					<h6 class="lead mt-4 text-light" style="font-weight:700;">Vente de produits porcins  </h6>
			</div>			
		</div>
	</div>

	<div class="s-3 container pt-5 pb-5">
		<div class="s-3-blocks">
			<div class="block1">
				<p class="lead p1" style="font-weight: 600;font-size: 1.6em;">Nous sommes fiers d'être l'un des meilleurs éleveurs du pays.
				</p>				
			</div>

			<img class="img-fluid" src="../images/pigservice.png">
		</div>

		<div class="s-3-blocks">
			<h2>En tant que propriétaire d'un élevage de volailles, Nous prenons personnellement soin des produits que nous offrons à nos clients et partenaires.</h2>
			<p class="lead">Notre entreprise, F4 Ferme S.A.R.L., est composée d'une équipe passionnée d'experts en élevage porcin et en transformation des produits. Nous valorisons l'excellence, le respect de l'environnement et le bien-être animal dans toutes nos activités.</p>

			<div class="block2 mt-5 px-3">
				<p class="lead" style="font-weight: 600;">Nous sommes fiers de collaborer avec des marques renommées dans l'industrie alimentaire</p>
			</div>
		</div>
	</div>

	<div class="s-4 container d-flex mb-5 justify-content-between">
		<div>
			<img class="img-fluid w-100" src="../images/elevage1.png">
		</div>	

		<div class="mb-4 px-1 px-md-3 px-lg-5 py-3 py-lg-5" style="background-color: #ffd55f;">
			<h1>Elevage de porc</h1>
			<p class="lead">Nous élevons nos porcs dans des conditions optimales, en veillant à leur santé, à leur alimentation équilibrée et à leur confort.</p>
		</div>
	</div>
	...
	<div class="s-4 container d-flex mb-5 justify-content-between">	
		...
		<div class="mb-4 px-1 px-md-3 px-lg-5 py-3 py-lg-5" style="background-color: #fdefed;">
			<h1>Transformation des produits porcins </h1>
			<p class="lead">Nous utilisons des méthodes de transformation artisanales pour garantir des produits de qualité supérieure, tels que des saucisses, des jambons, des charcuteries, etc.</p>
		</div>

		<div>
			<img class="img-fluid w-100" src="../images/transformation1.png">
		</div>
	...
	<div class="s-4 container d-flex mb-5 justify-content-between">	
		...
		<div>
			<img class="img-fluid w-100" src="../images/vente1.png">
		</div>

		<div class="mb-4 px-1 px-md-3 px-lg-5 py-3 py-lg-5" style="background-color: #fdefed;">
			<h1>Vente des produits porcins </h1>
			<p class="lead">: Nous proposons une large gamme de produits porcins frais et transformés, soigneusement emballés et prêts à être dégustés.</p>
		</div>
